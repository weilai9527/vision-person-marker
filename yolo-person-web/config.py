...
ENABLE_TILE_DETECTION = os.environ.get("ENABLE_TILE_DETECTION", "1") == "1"
TILE_GRID = int(os.environ.get("TILE_GRID", "2"))
TILE_OVERLAP = float(os.environ.get("TILE_OVERLAP", "0.18"))
NMS_IOU_THRESHOLD = float(os.environ.get("NMS_IOU_THRESHOLD", "0.35"))
...
YOLO_IMGSZ = int(os.environ.get("YOLO_IMGSZ", "1536"))
YOLO_MIN_AREA = int(os.environ.get("YOLO_MIN_AREA", "20"))
YOLO_DEVICE = os.environ.get("YOLO_DEVICE", "auto")
YOLO_HALF = os.environ.get("YOLO_HALF", "auto")
...
CAMERA_CONF = float(os.environ.get("CAMERA_CONF", "0.50"))
CAMERA_IOU = float(os.environ.get("CAMERA_IOU", "0.50"))
CAMERA_IMGSZ = int(os.environ.get("CAMERA_IMGSZ", "1280"))
CAMERA_MIN_AREA = int(os.environ.get("CAMERA_MIN_AREA", "300"))
CAMERA_DUPLICATE_IOU = float(os.environ.get("CAMERA_DUPLICATE_IOU", "0.28"))
CAMERA_DUPLICATE_CONTAINMENT = float(os.environ.get("CAMERA_DUPLICATE_CONTAINMENT", "0.62"))
CAMERA_MAX_DET = int(os.environ.get("CAMERA_MAX_DET", "80"))
CAMERA_USE_TRACKER = os.environ.get("CAMERA_USE_TRACKER", "1") == "1"
CAMERA_TRACK_CONFIRM_FRAMES = int(os.environ.get("CAMERA_TRACK_CONFIRM_FRAMES", "2"))
CAMERA_TRACK_MAX_MISSES = int(os.environ.get("CAMERA_TRACK_MAX_MISSES", "18"))
CAMERA_TRACK_MERGE_DISTANCE = float(os.environ.get("CAMERA_TRACK_MERGE_DISTANCE", "0.72"))
